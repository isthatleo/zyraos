...
- Name: tests\student-parent-dashboards-render.e2e.spec.ts >> Student and parent dashboard render budget from login >> parent dashboard pages load from tenant login and render inside 6s
- Location: tests\student-parent-dashboards-render.e2e.spec.ts:111:3
...
- generic [active] [ref=e1]:
  - generic [ref=e3]:
    ...
    - generic [ref=e7]:
      - generic [ref=e8]:
        - img [ref=e10]
        - generic [ref=e15]: Parent / Guardian Login
        - generic [ref=e16]: Sign in to Asake
      - generic [ref=e18]:
        - generic [ref=e19]: Invalid origin
        - generic [ref=e20]:
        ...
        - generic [ref=e27]:
          - img [ref=e28]
          - paragraph [ref=e31]: Access is verified against this school and selected role before opening the dashboard.
