/**
 * Secondary Student Sidebar Navigation
 * Path: src/components/student/secondary-sidebar-nav.tsx
 */
...
export function SecondaryStudentSidebarNav() {
  ...
  const items = [
    {
      label: 'My Dashboard',
      href: '/student/secondary/dashboard',
      icon: <LayoutDashboard className="h-5 w-5" />,
    },
    {
      label: 'Academics',
      href: '/student/secondary/academics',
      icon: <BookOpen className="h-5 w-5" />,
      children: [
        { label: 'All Subjects', href: '/student/secondary/subjects' },
        { label: 'Assignments', href: '/student/secondary/assignments' },
        { label: 'Upcoming Exams', href: '/student/secondary/exams' },
        { label: 'Performance', href: '/student/secondary/performance' },
      ],
    },
    {
      label: 'Schedule',
      href: '/student/secondary/schedule',
      icon: <Calendar className="h-5 w-5" />,
    },
    {
      label: 'Grades & Results',
      href: '/student/secondary/grades',
      icon: <Award className="h-5 w-5" />,
    },
    {
      label: 'Fee Status',
      href: '/student/secondary/fees',
      icon: <DollarSign className="h-5 w-5" />,
    },
    {
      label: 'Messages',
      href: '/student/secondary/messages',
  ...
  return (
    <div className="w-64 bg-slate-900 border-r border-slate-700 h-screen overflow-y-auto">
      ...
      <div className="p-6 border-b border-slate-700">
        ...
        <p className="text-xs text-slate-400">Secondary Student</p>
      </div>
        ...
        <button className="w-full flex items-center justify-between px-4 py-2 rounded-lg text-sm text-slate-300 hover:bg-slate-700 transition-colors">
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              ...
              <p className="text-xs text-slate-400">Grade 10A</p>
            </div>
          </div>
