 ...
 * Path: src/components/student/sidebar-nav.tsx
 */
...
export function StudentSidebarNav() {
  ...
  const items = [
    ...
    },
    {
      ...
      children: [
        { label: 'My Subjects', href: '/student/academics/subjects' },
        { label: 'Exams & Results', href: '/student/academics/results' },
        { label: 'Assignments', href: '/student/academics/assignments' },
        { label: 'Learning Resources', href: '/student/academics/resources' },
      ],
    },
    {
        ...
        <button className="w-full flex items-center justify-between px-4 py-2 rounded-lg text-sm text-slate-300 hover:bg-slate-700 transition-colors">
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              ...
              <p className="text-xs text-slate-400">JHS 2A</p>
            </div>
          </div>
