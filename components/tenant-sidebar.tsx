...
const navigation = [
  ...
  },
  {
    title: "Resources",
    items: [
      { name: "Learning Materials", href: "/student/resources", icon: FolderIcon },
      { name: "Attendance & Schedule", href: "/student/attendance", icon: CalendarIcon },
    ],
  },
]
...
export default function TenantSidebar() {
  ...
  const userDisplayName = user?.name || "John Doe"
  const userEmail = user?.email || "student@roxan.com"
  ...
  // Determine tenant base profile path
  const getTenantProfilePath = () => {
      ...
      <div className="mt-auto border-t border-sidebar-border p-4">
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-56">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem onClick={() => router.push(getTenantProfilePath())}>
