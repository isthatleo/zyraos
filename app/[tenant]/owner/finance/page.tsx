      ...
      <div className="space-y-6">
        <Card className="overflow-hidden border-border/70 bg-card/80 shadow-sm backdrop-blur">
          <CardContent className="p-6 md:p-8">
            ...
            <p className="mt-2 max-w-3xl text-sm leading-6 text-muted-foreground">Loading collections, balances, invoices, ledger activity, and platform billing exposure.</p>
          </CardContent>
        </Card>
