  ...
  return (
    <div className="space-y-6">
            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              <div className="max-w-3xl">
                ...
                <p className="mt-2 text-sm leading-6 text-muted-foreground">
                  Owner-scoped internal chat with realtime messaging, typing state, presence, read receipts, voice calls, and video calls.
                </p>
              </div>
              <div className="grid gap-2 text-sm sm:grid-cols-2">
                <div className="rounded-2xl border bg-card/70 p-3">
                  ...
                  <p className="text-xs text-muted-foreground">School admins, admins, master and super admins.</p>
                </div>
                <div className="rounded-2xl border bg-card/70 p-3">
                  <Users className="mb-2 h-4 w-4 text-primary" />
                  <p className="font-medium">Restricted by role</p>
                  <p className="text-xs text-muted-foreground">Student, parent, and general staff chats are blocked here.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <QueryClientProvider client={queryClient}>
        <MessagesPage apiBaseOverride="/api/messages" heading="Owner Messages" />
      </QueryClientProvider>
    </div>
  );
}
